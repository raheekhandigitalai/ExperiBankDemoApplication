...
public class TestClass extends BaseClass {
    ...
    public void makePaymentTest() throws InterruptedException {
        getWait().until(ExpectedConditions.elementToBeClickable(By.name("usernameTextField")));
        ...
        getWait().until(ExpectedConditions.elementToBeClickable(By.name("cancelButton")));
